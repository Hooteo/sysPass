...
a.find("input[type='text'],input[type='password']").val("");0<d.length&&d.hide();$("#mpass").prop("disabled",!1).val("");$("#smpass").show();break;case 5:sysPassApp.msg.out(b);a.find("input[type='text'],input[type='password']").val("");0<d.length&&d.hide();$("#oldpass").prop("disabled",!1).val("");$("#soldpass").show();break;case 8:sysPassApp.msg.out(b);$("#mfacode").prop("disabled",!1).val("");0<d.length&&d.hide();$("#s2fa").show();$("#mfacode").focus();break;default:sysPassApp.msg.out(b),a.find("input[type='text'],input[type='password']").val("")}})},install:function(a){c.info("main:install");var b=sysPassApp.requests.getRequestOpts();
